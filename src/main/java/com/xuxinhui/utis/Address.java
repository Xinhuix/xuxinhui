...
public class Address {
        ...
        if (returnStr != null) {
          ...
          //  System.out.println("(1) unicode转换成中文前的returnStr : " + returnStr);
            ...
            return returnStr;
             ...
             int i=0;
                for(int j=5;j>i;i++){
                    String SecondaryQuery = getResult(urlStr, content, encodingString);
                    if(SecondaryQuery!=null){
                        // 处理返回的省市区信息
                        returnStr = decodeUnicode(SecondaryQuery);
                        String[] temp = returnStr.split(",");
                        if(temp.length<3){
                            return "0";//无效IP，局域网测试
                        }
    ...
    public static void main(String[] args) {
       Address addressUtils = new Address();
    // 测试ip 219.136.134.157 中国=华南=广东省=广州市=越秀区=电信
    String ip = "101.91.60.107";
    String address = "";
        try {
    ...
    /*    JSONArray jsonArray=JSONArray.fromObject(user);
        System.out.println("这是josn:"+jsonArray);

        Object o=jsonArray.get(0);
        JSONObject jsonObject2=JSONObject.fromObject(o);
        Object o1 = JSONObject.toBean(jsonObject2, dataUtis.class);
        System.out.println("stu:"+o1);
